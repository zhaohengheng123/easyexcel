package com.epoint.excel.context;
...
import com.epoint.excel.enums.WriteTypeEnum;
...
import com.epoint.excel.util.WorkBookUtil;
...
import com.epoint.excel.write.metadata.holder.WriteHolder;
...
public class WriteContextImpl implements WriteContext
{
    ...
    private void addMergedRegionToCurrentSheet(ExcelWriteHeadProperty excelWriteHeadProperty, int rowIndex) {
        for (com.epoint.excel.metadata.CellRange cellRangeModel : excelWriteHeadProperty.headCellRangeList()) {
