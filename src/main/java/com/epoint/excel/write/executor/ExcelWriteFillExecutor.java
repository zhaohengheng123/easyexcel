package com.epoint.excel.write.executor;
...
import com.epoint.excel.context.WriteContext;
import com.epoint.excel.enums.CellDataTypeEnum;
import com.epoint.excel.enums.WriteDirectionEnum;
import com.epoint.excel.enums.WriteTemplateAnalysisCellTypeEnum;
...
import com.epoint.excel.util.WriteHandlerUtils;
import com.epoint.excel.write.metadata.fill.AnalysisCell;
import com.epoint.excel.write.metadata.fill.FillConfig;
import com.epoint.excel.write.metadata.fill.FillWrapper;
...
public class ExcelWriteFillExecutor extends AbstractExcelWriteExecutor
{
     ...
     */
    private Map<String, List<AnalysisCell>> templateCollectionAnalysisCache = new HashMap<String, List<AnalysisCell>>(
            8);
    /**
     * Style cache for collection fields
     */
    private Map<String, Map<AnalysisCell, CellStyle>> collectionFieldStyleCache = new HashMap<String, Map<AnalysisCell, CellStyle>>(
            8);
    /**
     ...
     */
    private Map<String, Map<AnalysisCell, Integer>> collectionLastIndexCache = new HashMap<String, Map<AnalysisCell, Integer>>(
            8);
    ...
    private void doFill(List<AnalysisCell> analysisCellList, Object oneRowData, FillConfig fillConfig,
        ...
        Map<String, ExcelContentProperty> fieldNameContentPropertyMap = writeContext.currentWriteHolder()
                .excelWriteHeadProperty().getFieldNameContentPropertyMap();
        for (AnalysisCell analysisCell : analysisCellList) {
