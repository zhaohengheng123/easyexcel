...
public class WriteWorkbook extends WriteBasicParameter {
     ...
     */
    @Deprecated
    private com.epoint.excel.event.WriteHandler writeHandler;
    ...
    public com.epoint.excel.event.WriteHandler getWriteHandler() {
        return writeHandler;
    }

    public void setWriteHandler(com.epoint.excel.event.WriteHandler writeHandler) {
