package com.epoint.excel.annotation;
...
public @interface ExcelProperty {
    ...
    /**
     *
     * default @see com.epoint.excel.util.TypeUtil if default is not meet you can set format
     *
     * @return Format string
     * @deprecated please use {@link com.epoint.excel.annotation.format.DateTimeFormat}
     */
    @Deprecated
