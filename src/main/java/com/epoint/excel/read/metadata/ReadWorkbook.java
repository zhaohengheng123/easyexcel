package com.epoint.excel.read.metadata;
...
import com.epoint.excel.read.listener.ModelBuildEventListener;
...
public class ReadWorkbook extends ReadBasicParameter {
     ...
     * <p>
     * if true , you can use {@link com.epoint.excel.annotation.ExcelIgnore} ignore a field.
     * <p>
     * if false , you must use {@link com.epoint.excel.annotation.ExcelProperty} to use a filed.
     *
