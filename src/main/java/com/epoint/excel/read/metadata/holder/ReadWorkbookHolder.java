...
import com.epoint.excel.cache.selector.EternalReadCacheSelector;
import com.epoint.excel.cache.selector.ReadCacheSelector;
import com.epoint.excel.cache.selector.SimpleReadCacheSelector;
...
import com.epoint.excel.event.AnalysisEventListener;
...
public class ReadWorkbookHolder extends AbstractReadHolder {
    ...
    /**
     * Select the cache.Default use {@link com.epoint.excel.cache.selector.SimpleReadCacheSelector}
     */
    ...
    /**
     * The default is all excel objects.if true , you can use {@link com.epoint.excel.annotation.ExcelIgnore} ignore a
     * field. if false , you must use {@link com.epoint.excel.annotation.ExcelProperty} to use a filed.
     *
